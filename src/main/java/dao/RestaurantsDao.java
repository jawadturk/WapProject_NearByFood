...
public class RestaurantsDao {
    ...
    public RestaurantsDao() {
        ...
        restaurant2.addReview(new Review("2", "Spent good time there!", "2018-05-16", 3));
        restaurant2.addReview(new Review("2", "It was okay!", "2018-05-15", 4));
        ...
        restaurant3.addReview(new Review("3", "Spent good time there!", "2018-05-14", 1));
        restaurant3.addReview(new Review("3", "It was okay!", "2018-05-13", 2));
